...
/*
 * Description:     This class is the EvasionState of the AI
 * Version:         1.1.0
...
[CreateAssetMenu(menuName = "AI/States/Evasion")]
...
public class EvasionState : State
{
    ...
    {
        Debug.Log("Entering State: Evasion");
    ...
    {
        Debug.Log("Exiting State: Evasion");
    }
    ...
    // Condition for transitioning to EVASION STATE
