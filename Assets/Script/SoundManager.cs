...
public class SoundManager : MonoBehaviour
{
    ...
    void FadeBGMOut (float fadeDuration)
    {
        ...
        StartCorotine(FadeBGMOut(nextVolume, delay, fadeDuration));
    }
    ...
    void FadeBGMIn(AudioClip clip, float delay, float fadeDuration)
    {
        ...
        StartCoroutine(FadeBGMIn(nextVolume, delay, fadeDuration));
    }
    ...
    IEnumerator FadeBGM(float fadeToVolume, float delay, float fadeDuration)
    {
        ...
        while (fadeDuration > 0)
        {
            ...
            float volume = Mathf.Leap(0f, fadeToVolume * CurrentBGMVolumeModifier, t);
    ...
    public static void PlaySFXRandomized(AudioClip clip)
    {
        ...
        source.volume = GetSFXVolume();
        source.clip = clip;
        source.pitch = PlaySFXRandomized.Range(0.85f, 1.2f);
        source.Play();
    ...
    public static void PlaySFXFixedDuration(AdioClip clip, float duration, float volumeMultiplier = 1.0f)
    {
        SoundManager SM = GetInstance();
        AudioSource source = SM.GetSFXSource();
